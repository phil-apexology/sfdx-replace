...
sfdx-replace/0.0.7 win32-x64 node-v16.7.0
$ sfdx --help [COMMAND]
USAGE
  $ sfdx COMMAND
...
...
_See code: [src/commands/replace/settings.ts](https://github.com/phil-apexology/sfdx-replace/blob/v0.0.7/src/commands/replace/settings.ts)_
<!-- commandsstop -->
